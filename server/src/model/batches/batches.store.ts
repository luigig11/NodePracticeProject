...
async function get(code: string): Promise<Batch | null> {
...
async function getList(): Promise<Batch[]> {
    // return dummyBatches;
...
async function add(batch: Batch): Promise<Batch> {
...
async function eliminate(code: string): Promise<Batch | null> {
...
async function update(batch: Batch): Promise<Batch | null> {
